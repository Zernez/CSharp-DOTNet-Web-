...
public class NorthwindService : INorthwindService {
    ...
    public NorthwindService(NorthwindContext db) { this.db = db; } 
    ...
    public Task<Customer> CreateCustomerAsync(Customer c) { 
        db.Customers.Add(c); db.SaveChangesAsync(); return Task.FromResult(c); 
    }
    public Task<Customer> UpdateCustomerAsync(Customer c) { 
        db.Entry(c).State = EntityState.Modified; db.SaveChangesAsync(); return Task.FromResult(c); 
