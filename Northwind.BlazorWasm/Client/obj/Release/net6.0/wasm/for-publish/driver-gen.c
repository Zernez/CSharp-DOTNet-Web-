...
extern void *mono_aot_module_System_Runtime_Caching_info;
...
extern void *mono_aot_module_System_Windows_Extensions_info;
extern void *mono_aot_module_Northwind_BlazorWasm_Shared_info;
extern void *mono_aot_module_Northwind_Common_EntityModels_SqlServer_info;
...
void register_aot_modules ()
{
	...
	mono_aot_register_module (mono_aot_module_System_Runtime_Caching_info);
	...
	mono_aot_register_module (mono_aot_module_System_Windows_Extensions_info);
	mono_aot_register_module (mono_aot_module_Northwind_BlazorWasm_Shared_info);
	mono_aot_register_module (mono_aot_module_Northwind_Common_EntityModels_SqlServer_info);
